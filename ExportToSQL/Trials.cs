...
//        private string excelConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=\"C:\\Users\\Aishat Akinyemi\\Downloads\\PaymentTemplate.xlsx\";Extended Properties=\"Excel 8.0;HDR=TRUE\"";
...
//                    string sqlConnectionString = @"Data Source=AISHATAKINYEMI\SQLEXPRESS;Initial Catalog=db.mdl;Integrated Security=True";

//                    // Bulk Copy to SQL Server
//                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(sqlConnectionString))
//                    {
//                        bulkCopy.DestinationTableName = "Payment";
...
//               new DataColumn("PaymentDate", typeof(int)), /* could have to be changed*/
...
//                int paymentDate = Convert.ToInt32(row.Cells[0].Value);
...
//                            exToSql.DestinationTableName = "dbo.Payment";
